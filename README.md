...
The main AStar() function returns a AStarResult class-object which provides the __hole path went__ , 
the total __amount of moves__ done, 
as well as a method to __print out the hole maze__
